		...
		return {
			...
			controller: ['$scope', function ($scope) {
				...
				$scope.$on('credits-updated', function (event, data) {
					$scope.directors = $scope.movie.data.credits.crew.filter(function (a) {
						return a.job === 'Director'
					});
...
(function (module) {
	...
	module.service('movieService', ['$http', '$q', '$rootScope', function ($http, $q, $rootScope) {
